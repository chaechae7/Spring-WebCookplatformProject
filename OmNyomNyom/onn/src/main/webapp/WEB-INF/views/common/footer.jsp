<!-- Footer Section -->
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="footer-widget pl-0 pl-lg-5">
                        ...
                        <form class="infor-form">
                            ...
                            <button><img src="${pageContext.request.contextPath }/resources/images/icons/send.png" alt=""></button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="back-to-top"><img src="${pageContext.request.contextPath }/resources/images/icons/up-arrow.png" alt=""></div>

    <!-- Search model -->
    <div class="search-model set-bg" data-setbg="${pageContext.request.contextPath }/resources/images/search-bg.jpg">
        <div class="h-100 d-flex align-items-center justify-content-center">
            <div class="search-close-switch"><i class="material-icons">close</i></div>
            <form class="search-moderl-form">
                <input type="text" id="search-input" placeholder="Search">
                <button><img src="${pageContext.request.contextPath }/resources/images/icons/search-2.png" alt=""></button>
            </form>
        </div>
    </div>
    <!-- Search model end -->